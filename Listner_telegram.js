...
bot.command('info',(ctx) => {
  ctx.reply("Welcome to the Gameboyz Color Club".bold() + "a new NFT collection that takes inspiration from the beloved Game Boy Color console of the 90s. Our collection includes a variety of nostalgic and fun pixel art designs that will take you back in time to the golden age of gaming. But our collection is more than just a tribute to the past. We are also dedicated to bringing gamification and community engagement to the world of NFTs. Our club members will have access to a range of mini-games and challenges that will earn them exclusive rewards and prizes. In addition, we are developing new tools and services that will help push the NFT world forward. We believe that NFTs have the potential to revolutionize the way we think about ownership and value, and we want to be at the forefront of this change. By joining the Gameboyz Color Club, you become a part of a vibrant and innovative community of gamers, collectors, and NFT enthusiasts. We can't wait to see what the future holds for our club and the wider NFT ecosystem. So dust off your old Game Boy and join us on this exciting new adventure! Game Boyz Color Club is a private collection of 2222 NFTs-unique digital collectibles. The GameBoyz are stored as ERC-721 tokens on the Binance Smart Chain. \n"+"Each NFT will allow you to participate in our fantastic community, with access to special privileges such as games, reward systems, early access to future projects and collections from our ecosystem.".italics(), {
    reply_to_message_id: ctx.message.message_id,parse_mode: 'HTML', reply_markup: {
      inline_keyboard: [
        [
          { text: "Follow us of Twitter", url: "https://twitter.com/GBCCNFT" },
